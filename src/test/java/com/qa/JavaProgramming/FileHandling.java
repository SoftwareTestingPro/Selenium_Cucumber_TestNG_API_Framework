...
public class FileHandling {
	...
	public String filePath = System.getProperty("user.dir") + "/target/employee.xml";
	public String ModifiedFilePath = System.getProperty("user.dir") + "/target/employee-updated.xml";
	...
	public void ModifyXML() throws Exception {
		...
		System.out.println("XML file modified successfully. Access modified file at "+ModifiedFilePath);
	}
}